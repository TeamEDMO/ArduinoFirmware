...
SerialCommStream::SerialCommStream() : dataBuffer{} {}

void SerialCommStream::init()
{
    Serial.begin(115200);
}

void SerialCommStream::write(const uint8_t *const data, size_t length)
{
    Serial.write(data, length);
}

void SerialCommStream::write(uint8_t byte)
{
    write(&byte, 1);
}

void SerialCommStream::begin() {}
void SerialCommStream::end() {}
void SerialCommStream::update()
{
    if (!Serial)
        return;
